...
# --- 전략 파라미터 ---------------------------------------------------------
RUSH_SIZE = 7           # 한 번에 상대 본진으로 보낼 인원
BASE_COUNT = 0           # 본진 근처에 지을 기지 수
REPEAT_WAVES = True      # 1차 강습 후에도 15명 모이면 계속 보낸다
HOME_GUARD = 1           # 출격 후에도 본부에 남겨둘 최소 인원(일꾼 포함)
...
MAX_HQ_LEVEL = int(os.environ.get("RUSH_HQ_LV", 1))       # 본부 목표 레벨(훈련 2명/턴, 전사 체력 6)
